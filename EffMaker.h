...
const int oneDMHT_=14;
double OneDMHT_[oneDMHT_] = {100,150,200,250,300,350,450,500,600,700,900,1200,1700,8000};
...
double muPurityMHT_[mupurityMHT_] ={100,150,200,800,900,1200,9600};
...
double muAccHT_ [muaccHT_] = {500,800,1000,2500};
const int muaccMHT_ = 6;
double muAccMHT_ [muaccMHT_] = {100,150,200,550,700,2500};
...
double elecAccHT_ [elecaccHT_] = {500,800,1000,2500};
const int elecaccMHT_ = 6;
double elecAccMHT_ [elecaccMHT_] = {100,150,200,550,700,2500};
...
const int isotrackreductionMHT_ = 9;
double isoTrackReductionMHT_ [isotrackreductionMHT_] = {100,150,200,250,300,500,700,900,2500};
...
double isoTrackReductionActivity_ [isotrackreductionActivity_] = {1,20,40,60,150,1600};

// 2D
const int isotrackreductionBTags2D_ = 3;
double isoTrackReductionBTags2D_[isotrackreductionBTags2D_] = {0,1,10};
const int isotrackreductionNJets2D_ = 3;
double isoTrackReductionNJets2D_ [isotrackreductionNJets2D_] = {4,8,20};
...
double isoTrackReductionActivity2D_ [isotrackreductionActivity2D_] = {1,20,60,150,1600};
...
public :	
	...
	TH2F* ratioCalculatorSimple(TH2F* passTH2, TH2F* failTH2);
	TH1F* ratioCalculatorSimple(TH1F* passTH1, TH1F* failTH1);
	...
	//mu
	//1D
        double IsoTrackPass, IsoTrackPassMu, IsoTrackPassElec, IsoTrackPassPion;
        double IsoTrackFail, IsoTrackFailMu, IsoTrackFailElec, IsoTrackFailPion;
	...
	// ************************************************************************************************************* 22 June 2015 end ****************************************************
       ...
       // ************************************************************************************************************* 04 July 2015 ****************************************************
       TH1F *HadTauTrackSingleProngPT, *HadTauTrackSingleProngPTFail;
       TH1F *HadTauTrackSingleProngEta, *HadTauTrackSingleProngEtaFail;
       TH1F *HadTauTrackSingleProngPhi, *HadTauTrackSingleProngPhiFail;
       TH1F *HadTauTrackSingleProngActivity, *HadTauTrackSingleProngActivityFail;
       TH1F *HadTauTrackSingleProngHT, *HadTauTrackSingleProngHTFail;
       TH1F *HadTauTrackSingleProngMHT, *HadTauTrackSingleProngMHTFail;
       TH1F *HadTauTrackSingleProngNJets, *HadTauTrackSingleProngNJetsFail;
       TH1F *HadTauTrackSingleProngBTags, *HadTauTrackSingleProngBTagsFail;
       
       TH1F *HadTauTrackOneChargedAndNeutralsPT, *HadTauTrackOneChargedAndNeutralsPTFail;
       TH1F *HadTauTrackOneChargedAndNeutralsEta, *HadTauTrackOneChargedAndNeutralsEtaFail;
       TH1F *HadTauTrackOneChargedAndNeutralsPhi, *HadTauTrackOneChargedAndNeutralsPhiFail;
       TH1F *HadTauTrackOneChargedAndNeutralsActivity, *HadTauTrackOneChargedAndNeutralsActivityFail;
       TH1F *HadTauTrackOneChargedAndNeutralsHT, *HadTauTrackOneChargedAndNeutralsHTFail;
       TH1F *HadTauTrackOneChargedAndNeutralsMHT, *HadTauTrackOneChargedAndNeutralsMHTFail;
       TH1F *HadTauTrackOneChargedAndNeutralsNJets, *HadTauTrackOneChargedAndNeutralsNJetsFail;
       TH1F *HadTauTrackOneChargedAndNeutralsBTags, *HadTauTrackOneChargedAndNeutralsBTagsFail;
       
       
       TH1F *MuonTrackPT, *MuonTrackPTFail;
       TH1F *MuonTrackEta, *MuonTrackEtaFail;
       TH1F *MuonTrackPhi, *MuonTrackPhiFail;
       TH1F *MuonTrackActivity, *MuonTrackActivityFail;
       TH1F *MuonTrackHT, *MuonTrackHTFail;
       TH1F *MuonTrackMHT, *MuonTrackMHTFail;
       TH1F *MuonTrackNJets, *MuonTrackNJetsFail;
       TH1F *MuonTrackBTags, *MuonTrackBTagsFail;
       
       TH1F *ElectronTrackPT, *ElectronTrackPTFail;
       TH1F *ElectronTrackEta, *ElectronTrackEtaFail;
       TH1F *ElectronTrackPhi, *ElectronTrackPhiFail;
       TH1F *ElectronTrackActivity, *ElectronTrackActivityFail;
       TH1F *ElectronTrackHT, *ElectronTrackHTFail;
       TH1F *ElectronTrackMHT, *ElectronTrackMHTFail;
       TH1F *ElectronTrackNJets, *ElectronTrackNJetsFail;
       TH1F *ElectronTrackBTags, *ElectronTrackBTagsFail;
       // ************************************************************************************************************* 04 July 2015 end ****************************************************
