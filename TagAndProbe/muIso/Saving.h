...
public :
	Float_t passMTW, failMTW;
	Float_t passMTWHTMHTNJetsCut, failMTWHTMHTNJetsCut;
	Float_t passMTWHTMHTCut, failMTWHTMHTCut;
	Float_t passMTWHTCut, failMTWHTCut;
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   TTree					*tExpectation_,*tExpectation2_;
   // Declaration of leaf types
	 Int_t        passing, TagObjectsNum_,NJets_;
	 Float_t         eta;
	 Float_t         pt;
	 Float_t         Eta;
	 Float_t         HT;
